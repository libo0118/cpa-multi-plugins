...
// forceMaxThinking retains the high default for hy3/hy4-family models, while
// preserving the low effort explicitly offered by the current Hy3 catalog.
// Other unsupported effort values retain the historical high fallback. Matching is
